...
const Footer = () => {
    ...
    return (
        <div className="flex flex-row items-stretch justify-center xl:justify-between gap-2 px-4 max-md:flex-wrap mt-[50px] mx-[40px] sm:mx-[100px] pb-6 select-none">
            ...
            <div className="text-center pt-2 sm:pt-0 text-indigo-300 text-opacity-70 text-sm leading-6 tracking-wide whitespace-nowrap my-auto md:ml-[880px]">
