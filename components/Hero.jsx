...
const Hero = () => {
    ...
    const { ref: t4, inView: elementVisible4 } = useInView();
    return (
        <div className='flex flex-col items-center justify-center mt-[110px] select-none'>
            <div className=" justify-start items-center flex sm:px-[120px] px-0">
                ...
                <motion.div
                    ref={t1}
                    initial={{ opacity: 0 }}
                    animate={elementVisible1 ? { opacity: 1 } : { opacity: 0 }}
                    transition={{ delay: 0.3 }}
                    className="w-[273.20px] h-[36.39px] relative bg-opacity-0 rounded-[60px] shadow-inner backdrop-blur-[15px] flex-row flex justify-center items-center border border-indigo-300 border-opacity-20 ">
                    ...
                    <div className="text-center text-indigo-300 text-base font-normal leading-tight tracking-tight ml-2 mr-1">AI Integration</div>
                    <Image
                        src='/icons/arrow.svg'
                        alt='logo'
                        width={18}
            ...
            <motion.div
                ...
                className="text-center bg-gradient-to-b from-indigo-50 to-indigo-300 inline-block text-transparent bg-clip-text text-4xl sm:text-6xl max-w-sm sm:max-w-2xl font-bold leading-[50px] sm:leading-[70px] mb-4 ">An Opensource Cross Cloud Migration Tool
            </motion.div>
            <motion.div
                ref={t1}
                initial={{ opacity: 0 }}
                animate={elementVisible1 ? { opacity: 1 } : { opacity: 0 }}
                transition={{ delay: 0.1 }}
                className=" text-center text-indigo-300 text-lg font-normal leading-[31px] px-[20px] lg:px-[160px] xl:px-[420px] ">Xmigrate(pronounced as cross-migrate) is an opensource tool for migrating your VM'sfrom anywhere to cloud and cloud to anywhere seamlessly.
            </motion.div>
            <div className="justify-center items-start gap-6 inline-flex mt-[32px]">
                <motion.a
                    ...
                    animate={elementVisible1 ? { opacity: 1, x: 0 } : { opacity: 0, x: 0 }}
                    transition={{ delay: 0.5 }}
                    className=" pl-[22.23px] pr-[21.77px] pt-[16.22px] pb-[16.78px] bg-slate-800 hover:bg-slate-700 rounded-[58px] justify-center items-center flex text-violet-300 hover:text-violet-100">
                    <div className="w-[103px] h-5 text-center  text-base font-semibold leading-snug">Start Migrate</div>
                </motion.a>
                <motion.a
                    href='https://www.youtube.com/watch?v=FISJaoUIiOM'
                    target="_blank"
                    ref={t1}
                    initial={{ opacity: 0, x: 50 }}
                    animate={elementVisible1 ? { opacity: 1, x: 0 } : { opacity: 0, x: 0 }}
                    transition={{ delay: 0.5 }}
                    className=" pl-[25px] pr-[24.66px] pt-4 pb-[17.39px] bg-indigo-900 hover:bg-indigo-900 bg-opacity-20 rounded-[58px] border border-slate-800 justify-center items-center flex text-violet-300 hover:text-violet-200">
            ...
            <div className="pt-16 flex-col justify-start items-center gap-10 inline-flex">
                <div className="pl-[33.13px] pr-[32.94px] pt-1 pb-[5px] justify-center items-center inline-flex">
                    <motion.div
                        ref={t2}
                        initial={{ opacity: 0 }}
                        animate={elementVisible2 ? { opacity: 1 } : { opacity: 0 }}
                        transition={{ duration: 0.8 }}
                        className="text-center text-indigo-300 text-base leading-[31px] tracking-wide px-[40px] md:px-[200px] ">Xmigrate supports migration to all 3 major public cloud providers
                    </motion.div>
                </div>
                <motion.div
                    ref={t2}
                    ...
                    animate={elementVisible2 ? { opacity: 1 } : { opacity: 0 }}
                    transition={{ duration: 0.8 }}
                    className="items-center self-center flex max-w-full justify-between gap-[40px] md:gap-[90px] px-[50px] sm:px-[200px] max-md:flex-wrap max-md:justify-center mb-5">
                    <img
                        loading="lazy"
